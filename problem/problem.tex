...
\addproblem{雷立方阵列}{1000}{128}{传统}{Tifa}
...
第二行，$n$ 个整数 $a_1, a_2,...,a_n~(0\leq a_1, a_2,...,a_n<p)$, 含义见题目描述

第三行，一个整数 $q,~(1\leq q\leq 2\times 10^5)$, 表示操作次数

接下来 $m$ 行，每行均为且仅为如下格式之一
\begin{itemize}
	\item |1 x y k|: 将 $a_x,a_{x+1},...,a_y$ 加 $k$ 并对 $p$ 取模
	\item |2 x y|: 输出 $a_x,a_{x+1},...,a_y$ 间的\textbf{最大值}
\end{itemize}
